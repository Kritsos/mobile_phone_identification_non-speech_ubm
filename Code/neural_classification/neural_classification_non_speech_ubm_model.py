...
if __name__ == '__main__':
    ...
    y_train = scipy.io.loadmat("y_train_model.mat")
    y_train = y_train["y_train_model"]
    ...
    y_test = scipy.io.loadmat("y_test_model.mat")
    y_test = y_test["y_test_model"]
    ...
    disp = ConfusionMatrixDisplay(C, display_labels=phones)
    disp.plot()
    plt.show()