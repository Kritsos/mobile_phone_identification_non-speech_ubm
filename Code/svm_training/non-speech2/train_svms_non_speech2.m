% -----------------> train_svms_non_speech2.m <------------------- 

% The following code uses the speaker GMMs trained on the non speech MFCCs  
% of the ccnu_mobile dataset to extract the training GSVs and trains brand 
% and model SVMs using bayesian optimization for hyperparameter tuning. For 
% the training set we use both the GSVs with the means only and the GSVs with 
