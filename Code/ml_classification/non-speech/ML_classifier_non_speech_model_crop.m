% -----------------> ML_classifier_non_speech_model_crop.m <------------------- 

% The following code uses the model GMMs trained on the non speech MFCCs of
% the baseline + crop dataset and Maximum Likelihood classification to classify 
...
% example comes (1: baseline, 2: crop)
...
for i = 1:length(num_comp)
    ...
    disp("Accuracy of " + num2str(num_comp(i)) + "-component GMM: " + num2str(100 * acc) + "%: " + ...
         "Baseline: " + num2str(100 * acc_baseline) + "% / " + "Crop: " + num2str(100 * acc_crop) + "%")
