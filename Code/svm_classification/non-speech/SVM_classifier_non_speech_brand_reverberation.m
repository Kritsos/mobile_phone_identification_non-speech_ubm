% -----------------> SVM_classifier_non_speech_brand_reverberation.m <------------------- 

% The following code uses the multiclass SVMs trained on the MFCCs of the
% non speech frames of the baseline + reverberation dataset to classify each 
% test speaker recording to one of the 7 brands
