% -----------------> SVM_classifier_non_speech_model_crop.m <------------------- 

% The following code uses the multiclass SVMs trained on the MFCCs of the
% non speech frames of the baseline + crop dataset to classify each test 
...
for i = 1:length(num_comp)
    ...
    disp("Baseline: " + num2str(100 * acc_baseline) + "% / " + "Crop: " + num2str(100 * acc_crop) + "%")
