% -----------------> SVM_classifier_ubm_adapted_model_reverberation.m <------------------- 

% The following code uses the multiclass SVMs trained on the UBM means 
% adapted GSVs of the baseline + reverberation dataset to classify each test 
% speaker recording to one of the 21 models
