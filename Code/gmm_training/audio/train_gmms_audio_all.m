% -----------------> train_gmms_audio_all.m <------------------- 

% The following code uses the extracted training and testing MFCCs of all 
% the datasets and uses them to train GMMs with the number of components
