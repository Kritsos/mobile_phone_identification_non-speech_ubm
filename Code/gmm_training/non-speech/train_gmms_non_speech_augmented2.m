% -----------------> train_gmms_non_speech_augmented2.m <------------------- 

% The following code uses the extracted training and testing non speech MFCCs 
% of the augmented2 dataset and uses them to train GMMs with the number of 
% components being 1, 2, 4, 8, 16, 32 and 64. Brand and model dependent GMMs are
